...
public class AprilTagCamConstants {
  ...
  public static final String BACK_RIGHT_CAM = "cam6";
  public static final String BACK_LEFT_CAM = "cam7";
  public static final String FRONT_LEFT_CAM = "cam8";
  public static final String FRONT_RIGHT_CAM = "cam9";

  public static final Transform3d TEST_CAM_ONE_LOCATION =
      new Transform3d(0.306, 0.124, 0.17944, new Rotation3d(0, 0, 0));

...
public class FieldConstants {
  ...
  public static double BLUE_BUMP_X1 = Units.inchesToMeters(446.91 - ROBOT_DIAGIONAL_WIDTH / 2);
  public static double BLUE_BUMP_X2 =
      Units.inchesToMeters(446.91 + BUMP_WIDTH + ROBOT_DIAGIONAL_WIDTH / 2);

  public static double RED_BUMP_X1 = Units.inchesToMeters(121.30 - ROBOT_DIAGIONAL_WIDTH / 2);
  public static double RED_BUMP_X2 =
      Units.inchesToMeters(121.30 + BUMP_WIDTH + ROBOT_DIAGIONAL_WIDTH / 2);
